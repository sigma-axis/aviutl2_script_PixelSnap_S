...
local cx0, cy0, _ = obj.getvalue("center");
cx0, cy0 = obj.cx + cx0 + obj.w / 2, obj.cy + cy0 + obj.h / 2;
...
local x0, y0, _ = obj.getvalue("pos");
x0, y0 =
	x0 + obj.ox + obj.screen_w / 2,
	y0 + obj.oy + obj.screen_h / 2;
...
obj.ox, obj.oy = obj.ox + (x - x0), obj.oy + (y - y0);
